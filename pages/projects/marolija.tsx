...
import marolija2 from '../../public/projects/marolija2.png';
import marolija3 from '../../public/projects/marolija3.png';
import Link from 'next/link';
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import Head from 'next/head';

export default function Marolija() {
  const theme = useTheme();
  const primaryText = theme.palette.text.primary;
  const project: Project | undefined = projectData.find((project) => project.name === 'Marolija');
  if (project) {
    project.imageArray = [marolija2, marolija3];
  }
  return (
    <>
      <Head>
        <title>Marolija project | Pargeo portfolio</title>
        <meta
          name='description'
          content='Virtual assistant website'
        />
      </Head>
      <Typography
        variant='h1'
