...
import harmonie2 from '../../public/projects/harmonie2.png';
import harmonie3 from '../../public/projects/harmonie3.png';
...
export default function Mai() {
  ...
  const project: Project | undefined = projectData.find((project) => project.name === 'Harmonie');
  if (project) {
    project.imageArray = [harmonie2, harmonie3];
  }
  return (
    <>
      <Head>
        <title>Harmonie project | Pargeo portfolio</title>
        <meta
          name='description'
