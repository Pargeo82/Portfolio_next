// technologies must be in format: HTML CSS Javascript NodeJS React MongoDB...
...
const projectData = [
  ...
  },
  {
    ...
    description:
      "This site done in NextJS after a couple of iterations in other tech",
    technology: ["NextJS", "Typescript", "Sass"],
    link: "portfolio",
    linkType: "inside",
  },
  // {
